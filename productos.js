...
// ║  1. Copia el bloque de ejemplo del final                         ║
// ║  2. Pégalo antes del cierre ]; (última línea)                    ║
// ║  3. Cambia los valores                                           ║
// ║  4. Guarda — los cambios aparecen solos en la tienda             ║
// ║                                                                  ║
// ║  CAMPOS:                                                         ║
// ║    id        → identificador único, sin espacios ni tildes       ║
// ║    nombre    → nombre visible al cliente                         ║
// ║    desc      → descripción corta                                 ║
// ║    precio    → precio en CUP (solo el número)                    ║
// ║    foto      → nombre del archivo de imagen en la misma carpeta  ║
// ║    categoria → ver lista de categorías abajo                     ║
// ║    emoji     → se muestra si la foto no carga                    ║
// ║    unidad    → Lb, 1L, Unidad, 500g, etc.                       ║
// ║    stock     → cantidad disponible. Pon 0 para mostrar AGOTADO   ║
// ║                                                                  ║
// ║  CATEGORÍAS DISPONIBLES:                                         ║
// ║    "Granos"  "Lácteos"  "Carnes"  "Embutidos"  "Bebidas"        ║
// ║    "Condimentos"  "Conservas"  "Pan y Dulces"                    ║
// ║    "Limpieza"  "Aseo Personal"  "Otros"                          ║
// ╚══════════════════════════════════════════════════════════════════╝
...
const PRODUCTOS = [
  ...
  // Copia una línea existente y cambia los valores.
  // EJEMPLO (borra las // para activarlo):
  //
  // { id: "leche_fresca", nombre: "Leche Fresca", desc: "Leche fresca del día, entera", precio: 250, foto: "LecheFresca.jpg", categoria: "Lácteos", emoji: "🥛", unidad: "1L", stock: 8 },
  //
  // ⚠️  REGLAS PARA NO ROMPER LA PÁGINA:
  //   - Cada línea termina en },  (coma incluida, menos la última)
  //   - El stock: no lleva coma al final de la línea (la coma va en },)
  //   - El id no puede repetirse ni tener espacios
  // ════════════════════════════════════════════════════════════════
